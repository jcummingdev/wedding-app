    ...
    return(
        <>
            ...
            <div className="container" id="aboutUs">
                ...
                <div style={{width: '100%', height: '266px', position: 'relative'}}>
                    <Img src={'/xmas.jpg'} fill={true} alt="Christmas 2011" style={{objectFit: 'contain', objectPosition: 'center'}}/>
                </div>

                <p>It took two years before I finally had the nerve to say yes to him. At 15, I think we both knew that this was it but what kind of easy-peasy life would that be?</p>
